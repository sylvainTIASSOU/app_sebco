...
const Registre = () => {
    ...
    return (
        <div className=" mt-[35%] md:mt-[10%] px-3 md:px-20 min-h-screen flex w-full items-center justify-center">
            <div className="py-5 px-2 bg-white rounded-[15px] w-[500px] flex flex-col space-y-10 items-center justify-center ">
                <Image src={"/logo.svg"} alt={"logo"} width={200} height={200} className={'self-center'} quality={100}/>
                ...
                <form onSubmit={formik.handleSubmit} className=" flex flex-col space-y-5 md:w-[400px] ">
                    ...
                    <Button
                        size={"large"}
                        htmlType="submit"
                        className="p-2 w-auto text-black font-bold bg-slate-100"
                    >
                        S'inscrire
                    </Button>
                </form>
