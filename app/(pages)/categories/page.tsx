        ...
        return datas.map((cat, index) => {
            return (
                <Link href={`/product/${cat.id}`} key={index}
                      className={"flex flex-col px-2  items-center justify-center space-y-3  w-[150px]  h-[150px] bg-blue-400 shadow-2xl rounded-xl "}>
        ...
        <div className={'my-[25%] md:my-[10%] px-3 md:px-20 flex flex-col '}>
            ...
            <div className={"self-center my-10 "}>
                <div className={'px-3 flex space-x-3 '}>
                    ...
                    <button className={"p-3 rounded-full bg-blue-200"}>
                        <Search />
                    </button>
                </div>
            </div>
