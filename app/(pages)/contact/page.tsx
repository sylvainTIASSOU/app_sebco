...
export default function Contact() {
    ...
    return (
        <div className='mt-[35%] md:mt-[10%]  w-full px-3 md:px-20 flex flex-col items-center justify-center h-screen'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-5 items-center'>

                {/** info */}
                <div className="flex flex-col gap-2 bg-gray-300 p-3 w-full">
